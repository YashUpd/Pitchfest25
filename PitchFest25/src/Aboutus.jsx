...
const Aboutus = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-center md:items-stretch w-[90%] rounded-lg md:rounded-xl md:w-[80%] md:p-2 bg-white gap-2 items-center mt-12 md:mb-20 md:mt-10 px-2 py-2" id="home">
