...
const Categories = () => {
  return (
    <div className="flex justify-center w-[85%] md:w-[80%] max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center gap-6 p-4 mb-10 md:mb-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-10 md:gap-12 mt-4 sm:mt-4 xl:mt-4">
            <div className="flex flex-col items-center">
              ...
              <h1 className="text-center text-sm md:text-base font-medium">Clean Energy</h1>
            </div>
            <div className="flex flex-col items-center">
              ...
              <h1 className="text-center text-sm md:text-base font-medium">Deep Tech</h1>
            </div>
            <div className="flex flex-col items-center self-center mx-auto col-span-2 md:col-span-1">
              ...
              <h1 className="text-center text-sm md:text-base font-medium">Mobility</h1>
            </div>
          </div>
        </div>
      </div>
