...
const Register = () => {
  ...
  return (
    <div
      className="flex justify-center items-center bg-white rounded-lg md:rounded-xl shadow-2xl mt-6 mb-6 md:mt-6 w-[90%] md:w-[80%] h-full"
      id="registration"
    >
          ...
          <div className="flex flex-col justify-around gap-1 md:gap-2 py-2 md:p-2 bg-yellow-background w-2/3 rounded-lg">
            <div className="flex flex-col gap-0.5 md:gap-1 px-2 md:mb-2 py-2">
              ...
              <p className="text-black text-justify text-[10px] sm:text-xs md:text-lg md:mb-1 mb-0.5">
                ...
                innovation, connect with industry leaders, and secure funding
                for your startup. PitchFest 2025 is your chance to shine in
                front of top investors and mentors.
              </p>
            </div>
            <div className="flex flex-col gap-0.5 md:gap-2 px-2">
              ...
              <p className="text-black text-justify text-[10px] sm:text-xs md:text-lg">
                Take the first step towards transforming your idea into a
                thriving business. Click the button below to start your
